...
# Ровно 20 кнопок (5 рядов по 4), каждая — из своего часового пояса.
TZ_BUTTONS: list[str] = [
    "Лондон", "Париж", "Калининград", "Стамбул",
    "Москва", "Дубай", "Баку", "Ташкент",
    "Екатеринбург", "Алматы", "Бангкок", "Новосибирск",
    "Шанхай", "Сеул", "Владивосток", "Сидней",
    "Нью-Йорк", "Чикаго", "Мехико", "Лос-Анджелес",
]
